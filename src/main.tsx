...
class ErrorBoundary extends React.Component<{ children: React.ReactNode }, { hasError: boolean, error: Error | null }> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div style={{ padding: '2rem', color: 'white', backgroundColor: 'black', height: '100vh', width: '100vw' }}>
          <h1 style={{ color: '#ef4444' }}>React Rendering Error</h1>
          <pre style={{ marginTop: '1rem', whiteSpace: 'pre-wrap', wordWrap: 'break-word', color: '#fca5a5' }}>
